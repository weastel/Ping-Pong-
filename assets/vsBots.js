...
function resetBallComletely()
{
  ball.x = canvas.width / 2;
  ball.y = canvas.height / 2 ;
  ball.speed = 5*speedConstant*Math.sqrt(2);
...
function update() {
  ...
  if (collision(ball,player)) {
    ...
    ball.velocityY = ball.speed * Math.sin(angleRad)*speedConstant;

    ball.speed += 0.1*speedConstant;
